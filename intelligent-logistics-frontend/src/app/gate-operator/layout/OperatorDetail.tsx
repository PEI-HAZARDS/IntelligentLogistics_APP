    ...
    <div className="operator-layout">
      ...
      <header className="operator-header">
        <div className="header-left">
          ...
          <span className="header-subtitle">Painel de Gestão de Chegadas Diárias</span>
        </div>
      ...
      <footer className="operator-footer">
        <div className="footer-content">
          <span className="footer-copyright">© 2025 Porto Aveiro Staff Dashboard</span>
          <span className="footer-info">Sistema de Gestão de Logistica | Acesso Restrito</span>
        </div>
      </footer>
    </div>
  );
