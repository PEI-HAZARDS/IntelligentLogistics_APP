...
export default function EnergyMetrics() {
    ...
    return (
        <div className={`min-h-screen flex flex-col items-center justify-center p-4 xl:p-8 overflow-y-scroll ${
            isDarkMode
            ...
            <div className="w-full max-w-6xl flex flex-col gap-6">
                <div className="flex flex-col">
                    <h1 className={`text-4xl xl:text-5xl font-extrabold mb-2 tracking-tight ${
                ...
                <div className={`w-full rounded-xl overflow-hidden shadow-2xl flex justify-center p-6 ${
                    isDarkMode
