...
export default function WarningSign() {
    ...
    return (
        <div className="min-h-screen bg-neutral-900 text-white flex flex-col items-center justify-center p-4 xl:p-8 overflow-y-auto">
            <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-8 lg:gap-12 items-center mx-auto">
                        ...
                        <div className={`transition-all duration-500 w-full flex-1 flex flex-col items-center justify-center mt-8 mb-4 ${isActive ? 'opacity-100' : 'opacity-[0.03] grayscale'}`}>
                            ...
                            <div className="w-[200px] h-[200px] relative drop-shadow-[0_0_35px_rgba(255,255,255,0.2)]">
                                <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-[0_0_20px_rgba(227,0,15,0.9)]">
                                    ...
                                    {/* Truck container */}
                                    <path d="M 30 30 L 70 30 L 73 60 L 27 60 Z" fill="#000000" />

                                    {/* Orange label (Dangerous goods) */}
                                    <rect x="36" y="35" width="28" height="18" fill="#FF7F00" stroke="#000000" strokeWidth="1" />

                                    {/* Chassis line */}
                                    <rect x="24" y="62" width="52" height="3" fill="#000000" />

                                    {/* Wheels */}
                                    <rect x="27" y="65" width="5" height="12" fill="#000000" rx="1" />
                                    <rect x="34" y="65" width="5" height="12" fill="#000000" rx="1" />

                                    <rect x="68" y="65" width="5" height="12" fill="#000000" rx="1" />
                                    <rect x="61" y="65" width="5" height="12" fill="#000000" rx="1" />
