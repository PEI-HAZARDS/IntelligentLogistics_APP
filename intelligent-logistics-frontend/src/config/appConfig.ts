...
const config: AppConfig = {
    ...
    grafanaUrl: import.meta.env.VITE_GRAFANA_URL || 'http://10.255.32.100:3000',
    apiBaseUrl: import.meta.env.VITE_API_URL || 'http://10.255.32.100:8000/api',
    wsBaseUrl: import.meta.env.VITE_WS_URL || 'ws://10.255.32.100:8000/ws',
};
